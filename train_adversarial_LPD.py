...
optimizer_G = torch.optim.Adam(lpd_generator.parameters(), lr = 5e-5, betas=(0.5, 0.99))
optimizer_D = torch.optim.Adam(discriminator.parameters(), lr = 5e-5, betas=(0.5, 0.99))

############## main training loop ##############
lambda_cycle_image, lambda_cycle_data, lambda_gp = 10.0, 10.0, 10.0 

num_epochs = 25 #see the artifacts in the reconstruction and then modify the penalties. 
